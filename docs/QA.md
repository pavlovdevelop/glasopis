...
- [ ] На по-стара инсталация, „За Glasopis“ показва наличната нова версия след натискане на
      „Провери за обновление“.
- [ ] „Изтегли и инсталирай“ показва прогрес, инсталира се и Glasopis се рестартира на новата
      версия (проверка на версия от „За Glasopis“).
- [ ] Изключването на „Проверявай автоматично за нови версии“ в Общи настройки спира проверката
      при стартиране.
- [ ] Инсталатор с невалиден/липсващ подпис в `latest.json` се отхвърля с грешка, не се
      инсталира мълчаливо.
...
- [ ] Плаващата топка се влачи навсякъде по екрана; при следваща диктовка се появява на
      същото място.
- [ ] Преместена близо до ръб на екрана, топката остава изцяло видима (без да излиза извън
      монитора).
